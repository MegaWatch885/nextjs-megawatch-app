...
export default function watchep15() {
        ...
        <>
            ...
            <div className="mainmoviebx flex-center" id="flex">
                ...
                <div className="watchonlinemovie">
                    ...
                    <h2 className="movietrailer" id="movietrailer"> {alldata && alldata[0]?.title} - (Ep - 15) Streaming Here </h2>
                    ...
                    <center>
                        <div className="epstreaming">
                            <iframe width="80%" height="420"
                                src={alldata && alldata[0]?.watchEp15} frameBorder="0" allowFullScreen="allowFullScreen" name="player" loading="lazy">
                            </iframe>
                        </div>
                    </center>
                </div>
                ...
                <div className="btngroup">
                    ...
                    <a href={alldata && alldata[0]?.watchEp15} target="player"><button>Server 1</button></a>
                    <a href={alldata && alldata[0]?.watchEp15s2} target="player"><button>Server 2</button></a>
                    <a href={alldata && alldata[0]?.watchEp15s3} target="player"><button>Server 3</button></a>
