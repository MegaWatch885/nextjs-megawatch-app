...
export default function watchep18() {
        ...
        <>
            ...
            <div className="mainmoviebx flex-center" id="flex">
                ...
                <div className="watchonlinemovie">
                    ...
                    <h2 className="movietrailer" id="movietrailer"> {alldata && alldata[0]?.title} - (Ep - 18) Streaming Here </h2>
                    ...
                    <center>
                        <div className="epstreaming">
                            <iframe width="80%" height="420"
                                src={alldata && alldata[0]?.watchEp18} frameBorder="0" allowFullScreen="allowFullScreen" name="player" loading="lazy">
                            </iframe>
                        </div>
                    </center>
                </div>
                ...
                <div className="btngroup">
                    ...
                    <a href={alldata && alldata[0]?.watchEp18} target="player"><button>Server 1</button></a>
                    <a href={alldata && alldata[0]?.watchEp18s2} target="player"><button>Server 2</button></a>
                    <a href={alldata && alldata[0]?.watchEp18s3} target="player"><button>Server 3</button></a>
