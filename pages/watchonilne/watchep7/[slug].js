        ...
        <>
            ...
            <div className="mainmoviebx flex-center" id="flex">
                ...
                <div className="watchonlinemovie">
                    ...
                    <h2 id="movietrailer" className='movietrailer'>  {alldata && alldata[0]?.title} - (Ep - 07) Watch Online Here  </h2>
                    ...
                    <center>
                        <iframe width="80%" height="420"
                            src={alldata && alldata[0]?.watchEp07} frameBorder="0" allowFullScreen="allowFullScreen">
                        </iframe>
                    </center>
                </div>
