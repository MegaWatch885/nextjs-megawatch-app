...
export default function watchep16() {
        ...
        <>
            ...
            <div className="mainmoviebx flex-center" id="flex">
                ...
                <div className="watchonlinemovie">
                    ...
                    <h2 className="movietrailer" id="movietrailer"> {alldata && alldata[0]?.title} - (Ep - 16) Streaming Here </h2>
                    ...
                    <center>
                        <div className="epstreaming">
                            <iframe width="80%" height="420"
                                src={alldata && alldata[0]?.watchEp16} frameBorder="0" allowFullScreen="allowFullScreen" name="player" loading="lazy">
                            </iframe>
                        </div>
                    </center>
                </div>
                ...
                <div className="btngroup">
                    ...
                    <a href={alldata && alldata[0]?.watchEp16} target="player"><button>Server 1</button></a>
                    <a href={alldata && alldata[0]?.watchEp16s2} target="player"><button>Server 2</button></a>
                    <a href={alldata && alldata[0]?.watchEp16s3} target="player"><button>Server 3</button></a>
