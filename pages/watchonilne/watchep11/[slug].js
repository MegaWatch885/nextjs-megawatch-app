...
export default function watchep11() {
        ...
        <>
            ...
            <div className="mainmoviebx flex-center" id="flex">
                ...
                <div className="watchonlinemovie">
                    ...
                    <h2 id="movietrailer" className='movietrailer'>{alldata && alldata[0]?.title} - (Ep - 11) Streaming Here </h2>
                    ...
                    <center>
                        <iframe width="80%" height="420"
                            src={alldata && alldata[0]?.watchEp11} frameBorder="0" allowFullScreen="allowFullScreen" name="player" loading="lazy">
                        </iframe>
                    </center>
                </div>
                ...
                <div className="btngroup">
                    ...
                    <a href={alldata && alldata[0]?.watchEp11} target="player"><button>Server 1</button></a>
                    <a href={alldata && alldata[0]?.watchEp11s2} target="player"><button>Server 2</button></a>
                    <a href={alldata && alldata[0]?.watchEp11s3} target="player"><button>Server 3</button></a>
