...
export default function watchep1() {
    ...
    return <>
        ...
        <div className="mainmoviebx flex-center" id="flex">
            ...
            <div className="watchonlinemovie">
                ...
                <h2 className="movietrailer" id="movietrailer"> {alldata && alldata[0]?.title} - (Ep - 01) Streaming Here</h2>
                ...
                <center>
                    <div className="watchonlinemovie">
                        <iframe width="80%" height="420"
                            src={alldata && alldata[0]?.watchep01} frameBorder="0" allowFullScreen="allowFullScreen" name="player" loading="lazy">
                        </iframe>
                    </div>
                </center>
            </div>
            ...
            <div className="btngroup">
                ...
                <a href={alldata && alldata[0]?.watchep01} target="player"><button>Server 1</button></a>
                <a href={alldata && alldata[0]?.watchep01s2} target="player" alt="noimg"><button>Server 2</button></a>
                <a href={alldata && alldata[0]?.watchep01s3} target="player"><button>Server 3</button></a>
