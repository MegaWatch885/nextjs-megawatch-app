...
import { FaAngleDoubleUp, FaEye, FaFilm, FaHeart, FaStar } from "react-icons/fa";
    ...
    return <>
        ...
        <div className="mainmoviebx flex-center" id="flex">
            ...
            <div className="watchonlinemovie">
                ...
                <h2 className="movietrailer" id="movietrailer"> {alldata && alldata[0]?.title} - (Ep - 01) Watch Online Here</h2>
                ...
                <center>
                    <div className="watchonlinemovie">
                        <iframe width="80%" height="420"
                            src={alldata && alldata[0]?.watchep01} frameBorder="0" allowFullScreen="allowFullScreen">
                        </iframe>
                    </div>
                </center>
            </div>
