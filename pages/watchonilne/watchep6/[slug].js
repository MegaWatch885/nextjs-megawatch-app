...
export default function watchep6() {
        ...
        <>
            ...
            <div className="mainmoviebx flex-center" id="flex">
                ...
                <div className="watchonlinemovie">
                    ...
                    <h2 id="movietrailer" className='movietrailer'> {alldata && alldata[0]?.title} - (Ep - 06) Streaming Here </h2>
                ...
                <div className="btngroup">
                    ...
                    <a href={alldata && alldata[0]?.watchEp06} target="player"><button>Server 1</button></a>
                    <a href={alldata && alldata[0]?.watchEp06s2} target="player"><button>Server 2</button></a>
                    <a href={alldata && alldata[0]?.watchEp06s3} target="player"><button>Server 3</button></a>
